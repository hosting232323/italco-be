...
def upgrade() -> None:
  # ### commands auto generated by Alembic - please adjust! ###
    ...
    op.create_table('schedule_item_collection',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id'], ['schedule_item.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('schedule_item_order',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id')
        ...
        # 1) Create ScheduleItem per ogni Order che ha schedule_id
    op.execute("""
    ...
    # 2) Create ScheduleItemOrder (collega ogni order al proprio schedule_item)
    op.execute("""
    ...
    # 3) Se la collection_point va spostata a schedule_item_collection
    op.execute("""
