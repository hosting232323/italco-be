...
def upgrade() -> None:
  ...
  op.execute("""
    ...
    """)
  op.execute("""
    INSERT INTO schedule_item_collection (id, collection_point_id, schedule_item_id)
    SELECT id, collection_point_id, id
    FROM "order"
    WHERE schedule_id IS NOT NULL;
    """)
...
def downgrade() -> None:
  ...
  op.drop_table('schedule_item_collection')
